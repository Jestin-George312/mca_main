    ...
    <div className="min-h-screen w-full bg-[rgb(var(--color-bg))] text-[rgb(var(--color-text))] flex flex-col font-sans transition-colors duration-300">
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-[420px] bg-[rgb(var(--color-card))] border-[rgb(var(--color-border))] rounded-2xl p-8 sm:p-10 shadow-2xl dark:shadow-2xl">
          ...
          {/* Form Fields (Visual Only - Functionality is Google) */}
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input 
                ...
                className="w-full bg-[rgb(var(--color-input))] border-[rgb(var(--color-border))] rounded-lg px-4 py-3 text-sm text-[rgb(var(--color-text))] placeholder:text-[rgb(var(--color-muted))] focus:outline-none focus:ring-0 transition-colors"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-[rgb(var(--color-input))] border-[rgb(var(--color-border))] rounded-lg px-4 py-3 text-sm text-[rgb(var(--color-text))] placeholder:text-[rgb(var(--color-muted))] focus:outline-none focus:ring-0 transition-colors pr-10"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(prev => !prev)}
                  aria-label={showPassword ? 'Hide password' : 'Show password'}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-200 dark:text-slate-500 dark:hover:text-slate-300"
                >
            ...
            <button className="w-full bg-[rgb(var(--color-primary))] hover:opacity-95 text-white font-bold py-3 rounded-lg transition-all mt-6">
              Sign In
            </button>
            ...
            {/* Google Button (The Real Action) */}
            <button
              onClick={() => loginWithGoogle()}
              className="w-full bg-[rgb(var(--color-card))] border-[rgb(var(--color-border))] text-[rgb(var(--color-text))] hover:opacity-95 font-medium py-3 rounded-lg flex items-center justify-center gap-3 transition-all"
            >
              <img 
